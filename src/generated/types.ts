...
export type GetAnimeHistoryQueryVariables = Exact<{
  userName?: InputMaybe<Scalars['String']['input']>;
  type?: InputMaybe<MediaType>;
  status?: InputMaybe<MediaListStatus>;
  format?: InputMaybe<ScoreFormat>;
...
export type GetAnimeHistoryQuery = { __typename?: 'Query', MediaListCollection?: { __typename?: 'MediaListCollection', lists?: Array<{ __typename?: 'MediaListGroup', entries?: Array<{ __typename?: 'MediaList', id: number, status?: MediaListStatus | null, progress?: number | null, score?: number | null, media?: { __typename?: 'Media', episodes?: number | null, siteUrl?: string | null, title?: { __typename?: 'MediaTitle', english?: string | null, native?: string | null, userPreferred?: string | null } | null, coverImage?: { __typename?: 'MediaCoverImage', color?: string | null, large?: string | null } | null } | null, startedAt?: { __typename?: 'FuzzyDate', year?: number | null, month?: number | null, day?: number | null } | null, completedAt?: { __typename?: 'FuzzyDate', year?: number | null, month?: number | null, day?: number | null } | null } | null> | null } | null> | null } | null };


export const GetAnimeHistoryDocument = gql`
    query GetAnimeHistory($userName: String, $type: MediaType, $status: MediaListStatus, $format: ScoreFormat) {
  MediaListCollection(
    userName: $userName
    type: $type
    status: $status
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetAnimeHistory(variables?: GetAnimeHistoryQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetAnimeHistoryQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetAnimeHistoryQuery>(GetAnimeHistoryDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetAnimeHistory', 'query', variables);
    }
  };
}
